...
// rests
  ...
  Vega.fillText(Note.rest4Char, 210, 112);
...
// stems
  ...
  Vega.fillText(Note.stemChar, 168, 102);
...
// heads
  ...
  Vega.fillText(Note.headDark, 170, 122);
...
// accidentals
  ...
  Vega.fillText(Note.flatChar, 145, 122);
...
// sigils
  ...
  Vega.fillText(Sigil.vesta   + Sigil.cancer,       75,  50);
  Vega.fillText(Sigil.mars    + Sigil.gemini,      160,  45);
  Vega.fillText(Sigil.jupiter + Sigil.pisces,      245,  40);
  Vega.fillText(Sigil.venus   + Sigil.capricorn,   335,  50);
  Vega.fillText(Sigil.saturn  + Sigil.sagittarius, 425,  50);
  Vega.fillText(Sigil.sun     + Sigil.libra,       515,  50);
  Vega.fillText(Sigil.moon    + Sigil.leo,         605,  50);
