...
// upper note stems
  ...
  Vega.fillText(Note.stemChar, 373, 202);
...
// lower note stems
  ...
  Vega.fillText(Note.stemChar, 368, 352);
...
// lower sigils
  ...
  Vega.fillText(Sigil.vesta   + Sigil.cancer,      275, 300);
  Vega.fillText(Sigil.mars    + Sigil.gemini,      348, 295);
  Vega.fillText(Sigil.jupiter + Sigil.pisces,      445, 290);
  Vega.fillText(Sigil.venus   + Sigil.capricorn,   535, 300);
  Vega.fillText(Sigil.saturn  + Sigil.sagittarius, 625, 300);
  Vega.fillText(Sigil.sun     + Sigil.libra,       715, 300);
  Vega.fillText(Sigil.moon    + Sigil.leo,         805, 300);
