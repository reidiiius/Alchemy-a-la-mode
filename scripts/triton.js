...
// upper eighth rests
  ...
  Vega.fillText(Note.restChar, 685, 165);
  Vega.fillText(Note.restChar, 777, 165);

// lower eighth rests

  Vega.fillText(Note.restChar, 355, 365);
  Vega.fillText(Note.restChar, 685, 365);
  Vega.fillText(Note.restChar, 777, 365);
